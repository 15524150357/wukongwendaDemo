...
<!DOCTYPE html>
<!-- saved from url=(0045)https://www.wukong.com/user/?uid=101243966007 -->
<html lang="en">
<head>
    ...
    <%--<script>--%>
        <%--function upload() {--%>
            <%--var formobj1 =  document.getElementById("upload1");--%>
            ...
            <header id="pagelet-midbar" class="header-undefined">
                <div data-node="midbarInner" class="midbar-inner">
                    <div class="inner clearfix">
                        ...
                        <a href="question.jsp" data-node="ask" data-log="PopUp_CreateQuestion|From_" class="ask">提问</a>
                        <div class="nav logined"><a href="${pageContext.request.contextPath}/" data-log="Visit_Index|From_Link"
                            ...
                            <div class="nav-account">
                                <div data-node="user-account" class="nav-account-wrapper dropdown"><a
                                        ...
                                        src="./小猪HarryZhu - 悟空问答_files/3044413937" alt=""
                    ...
                    <div id="large-user-card" class="large-user-card">
                        <div id="widget-usercard-left" data-log-from="ProfileCard" class="w-usercard-left">
                            <div itemscope="itemscope" itemtype="http://schema.org/Person" class="userinfo clearfix"><a
                                ...
                                <div class="avatar">
                                    <form id="upload1" enctype="multipart/form-data">
                                        ...
                                        <input type="file" name="file1" onchange="upload();" class="uploadbtn">
                                    </form>
                                    <%--<img src="${pageContext.request.contextPath}/upload/touxiang.jpg" alt=""--%>
                                             <%--itemprop="image">--%>
                                </div>
                                <div class="user-desc"><h1 class="user-name"><span>${user_info.username}</span> <span
                                    ...
                                    <div><a href="javascript:;"><!----></a> <!---->
                                        <div class="edit-section"><a
                                                href="${pageContext.request.contextPath}/user/edit_user"
                            ...
                            <div class="user-data clearfix"><a
                                    href="${pageContext.request.contextPath}/follow/star_info"
                                    data-log="Visit_FollowerTab|From_" target="_blank" class="user-data-left"><h3>
                                ${star_num}
                            </h3> <span>关注</span></a> <a
                                    href="${pageContext.request.contextPath}/follow/fans_info"
                    ...
                    <div class="nav-wrapper-placeholder">
                        <div class="nav-wrapper">
                            <div class="nav"><a data-node="data-type" data-type="2"
                                                href="https://www.wukong.com/user/?uid=101243966007&amp;type=2"
                                    ...
                                    data-log="Visit_AnswerTab|From_" class="">回答 <span class="ans_count"></span></a>
                                <!----> <a data-node="data-type" data-type="1" href="${pageContext.request.contextPath}/question/favoriteflush"
                                ...
                                <div class="w-question-container">
                                    <div data-log-from="Feed" class="question-v3 has-pic">
                                        <div class="question-pic"><a
                                                ...
                                                src="./小猪HarryZhu - 悟空问答收藏_files/1780000bae31f2c7b621"></a></div>
                                        <div class="question-title"><h2><a
                                                href="https://www.wukong.com/question/6392033360809558274/"
                                                target="_blank"
                                                data-log="Visit_Question|From_Link">中国有哪些明星的国籍不是中国？</a></h2>
