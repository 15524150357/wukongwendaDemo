...
<!DOCTYPE html>
<!-- saved from url=(0035)https://www.wukong.com/user/?type=3 -->
<html lang="en">
<head>
                    ...
                    <div class="inner clearfix">
                        <div class="suspension-part">
                            <div class="logo-box"><a href="https://www.wukong.com/" data-log="Visit_Index|From_logo"
                                    ...
                                    src="${pageContext.request.contextPath}/upload/logo_5df43ca.png" alt="悟空问答" class="logo"></a>
                            </div>
                        ...
                        <div class="nav logined"><a href="${pageContext.request.contextPath}/" data-log="Visit_Index|From_Link"
                            ...
                            <div class="nav-account">
                                <div data-node="user-account" class="nav-account-wrapper dropdown"><a
                                        ...
                                        src="./小猪HarryZhu - 悟空问答收藏_files/3044413937" alt=""
                    ...
                    <div id="large-user-card" class="large-user-card">
                        <div id="widget-usercard-left" data-log-from="ProfileCard" class="w-usercard-left">
                            <div itemscope="itemscope" itemtype="http://schema.org/Person" class="userinfo clearfix"><a
                                    target="_self" href="${pageContext.request.contextPath}/follow/profileflush">
                                <meta itemprop="name" content="小猪HarryZhu">
                                <div class="avatar"><img src="${pageContext.request.contextPath}/upload/${user_info.picpath}" alt=""
                                                         itemprop="image"></div>
                                <div class="user-desc"><h1 class="user-name"><span>${user_info.username}</span> <span
                                    ...
                                    <div><a href="javascript:;"><!----></a> <!---->
                                        <div class="edit-section"><a
                                                href="https://www.wukong.com/editUser/?uid=101243966007"
                    ...
                    <div class="nav-wrapper-placeholder">
                        <div class="nav-wrapper">
                            <div class="nav"><a data-node="data-type" data-type="2"
                                                href="${pageContext.request.contextPath}/follow/profileflush"
                                                data-log="Visit_ActivTab|From_" class="">动态</a> <a data-node="data-type"
                                                                                                   data-type="0"
                                                                                                   href="https://www.wukong.com/user/?uid=101243966007&amp;type=0"
                                                                                                   data-log="Visit_AnswerTab|From_"
                                                                                                   class="">回答 <span
                                    class="ans_count"></span></a> <!----> <a data-node="data-type" data-type="1"
                                                                              href="javascript:;"
                                                                              data-log="Visit_FollowTab|From_"
                                                                              class="current">收藏 <span
                                    class="follow_count"></span></a> <a data-node="data-type" data-type="3"
                                                                         href="javascript:;"
                                                                         data-log="Visit_ManuscriptTab|From_"
                                                                         class="manuscript">草稿 <span
                                    class="manuscript_count"></span></a></div>
                        </div>
                    </div> <!---->
                    <div id="user-question-list" class="index-question-list">
                        <div data-log-from="Active" class="w-feed w-feed-profile-active" style="display: none;">
                        ...
                        <div data-log-from="Follow" class="w-feed w-feed-profile-follow" style="">
                            <div class="w-feed-container">
                                <div class="w-question-follow-display">
                                    <div class="w-question-container">
                                        <c:forEach items="${favorites}" var="favorite">
                                        <div data-log-from="Feed" class="question-v3 has-pic">
                                            <div class="question-pic"><a
                                                    href="https://www.wukong.com/question/6392033360809558274/"
                                                    target="_blank" data-log="Visit_Question|From_QuestionPic"><img
                                                    src=""></a></div>
                                            <div class="question-title"><h2><a
                                                    href="https://www.wukong.com/question/6392033360809558274/"
                                                    target="_blank"
                                                    data-log="Visit_Question|From_Link">${favorite.title}</a></h2>
                                                <div class="question-info"><span
                                                        class="question-answer-num">589回答</span><span
                                                        class="question-follow-num">958人收藏</span></div>
                                            </div> <!----> <!---->
                                            <div class="question-oper"><a href="javascript:"
                                                                          class="w-question-nointerest-btn"><i
                            ...
                            <div class="w-feed w-manuscript-wrapper" uid="101243966007" style="display: none;">
