...
<div id="wrapper">
                        ...
                        <div class="nav logined"><a href="home.do" data-log="Visit_Index|From_Link"
                            ...
                            <div class="nav-account">
                                <div data-node="user-account" class="nav-account-wrapper dropdown"><a
                                        ...
                                        src="./小猪HarryZhu - 悟空问答关注_files/3044413937" alt=""
                ...
                <div class="main-list">
                    <div class="nav-wrapper-placeholder">
                        <div class="nav-wrapper">
                            <div class="nav"><a href="javascript:;" class="current">我关注的人 ${star_num}</a> <a href="${pageContext.request.contextPath}/follow/fans_info"
                                                                                                   class="">我的粉丝 ${fans_num}</a>
                            </div>
                        </div>
                    </div>
                    <div id="attention-user-list" class="attention-user-list">
                        <div class="w-feed">
                            <div class="profile-attention hasFollows"><!---->
                                <div class="user">
                                    <c:forEach items="${starlist}" var="starinfo">
                            ...
                            <%--<div class="profile-fans hasFans"><!---->--%>
                                <%--<div class="user has-border">--%>
                                    <%--<div class="w-feed-active-follow-user-single clearfix"><a--%>
                                            ...
                                            <%--src="./小猪HarryZhu - 悟空问答关注_files/3033762272(1)"></a>--%>
                                        <%--<div class="desc"><a href="https://www.wukong.com/user/?uid=5548371641"--%>
                                                             <%--target="_blank" data-log="Visit_Profile|From_UserLink"--%>
                                                             <%--class="username only-username">手机用户5548371641--%>
                                            <%--<!----></a> <!----></div>--%>
                                        <%--<div class="follow-btn"><a data-log="Follow_User|From_"--%>
                                                                   <%--class="w-follow-btn both-followed"><i--%>
                                                <%--class="iconfont icon-details_add_icon"></i> <i--%>
                                                <%--class="iconfont icon-details_attention_icon"></i> <span>--%>
        <%--互相关注--%>
    <%--</span></a></div>--%>
                                    <%--</div>--%>
                                    <%--<div class="w-feed-active-follow-user-single clearfix"><a--%>
                                            <%--href="https://www.wukong.com/user/?uid=101780868271" target="_blank"--%>
                                            <%--data-log="Visit_Profile|From_Avatar" class="avatar"><img--%>
                                            <%--src="./小猪HarryZhu - 悟空问答关注_files/3033762272"></a>--%>
                                        <%--<div class="desc"><a href="https://www.wukong.com/user/?uid=101780868271"--%>
                                                             <%--target="_blank" data-log="Visit_Profile|From_UserLink"--%>
                                                             <%--class="username only-username">用户101780868271--%>
                                            <%--<!----></a> <!----></div>--%>
                                        <%--<div class="follow-btn"><a data-log="Follow_User|From_"--%>
                                                                   <%--class="w-follow-btn both-followed"><i--%>
                                                <%--class="iconfont icon-details_add_icon"></i> <i--%>
    ...
    <%--</span></a></div>--%>
                                    <%--</div>--%>
                                <%--</div>--%>
                                <%--<div class="anonymous">还有1位匿名用户关注了你</div>--%>
                            <%--</div>--%>
